...
{
	//return gtk2_hello::main(argc,argv);
	//return gtk2_hello2::main(argc,argv);
	//----------------
//	int param_argc=2;
//	char * parm_argv[2];
//	parm_argv[0]="box";
...
//	return gtk2_box::main(param_argc,parm_argv);//不能链接fprintf
	//----------------
	//return gtk2_container::main(argc,argv);
	//return gtk2_button_icon::main(argc,argv);
	//return gtk2_button_radio::main(argc,argv);
	//return gtk2_complex_one::main(argc,argv);
	//return gtk2_label::main(argc,argv);
	//return gtk2_arrow::main(argc,argv);
	//return gtk2_progress_bar::main(argc,argv);//很多编译错误,enum 不能 做|操作 ??
	//return gtk2_rule::main(argc,argv);
	//return gtk2_status_bar::main(argc,argv);
	...
	//return gtk2_event_box::main(argc,argv);
	//return gtk2_fixed::main(argc,argv);
	//return gtk2_frame::main(argc,argv);
	//return gtk2_aspect_frame::main(argc,argv);
	//return gtk2_paned::main(argc,argv);
	//return gtk2_scrolled_window::main(argc,argv);
	//return gtk2_button_box::main(argc,argv);
	//return gtk2_toolbar::main(argc,argv);
	//return gtk2_notebook::main(argc,argv);
	//return gtk2_menu::main(argc,argv);
