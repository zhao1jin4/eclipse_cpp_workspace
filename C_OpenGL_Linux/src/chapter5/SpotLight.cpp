...
void RenderScene(void)
    ...
    glPushMatrix();	
        ...
        glLightfv(GL_LIGHT0,GL_POSITION,lightPos);//设置灯光位置和方向,按上下左右键是,移动整个场景
        ...
        glutSolidCone(4.0f,6.0f,15,15);//画在上面设置的位置中
...
void SetupRC()
    ...
    glLightfv(GL_LIGHT0,GL_DIFFUSE,ambientLight);//设置灯光参数
