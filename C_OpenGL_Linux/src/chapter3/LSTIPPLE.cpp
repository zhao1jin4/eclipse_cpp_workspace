...
void RenderScene(void)
	...
	GLushort pattern = 0x0055;	// Stipple pattern
	...
	for(y = -90.0f; y < 90.0f; y += 20.0f)
		...
		glLineStipple(factor,pattern);//虚线,放大因子,pattern是16位做为一段,从右向左,1是线,0是空
...
void SetupRC()
	...
	glColor3f(0.0f, 1.0f, 0.0f);
        ...
        // Enable Stippling
	glEnable(GL_LINE_STIPPLE);//要打开,还可用glLineStipple
	}
