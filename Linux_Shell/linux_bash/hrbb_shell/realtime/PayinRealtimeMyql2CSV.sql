...
from  payin_realtime_pubtrandef d left join  payin_realtime_pubtranext e
on  d.batchno=e.batchno and
d.memocode=e.memocode and
d.keyword =e.keyword  
where d.trandate >= date_add(CURRENT_DATE, interval -3 day)   and 
d.dbaccount in 
(
 '680101416030010002',
 '680101416030010008',
