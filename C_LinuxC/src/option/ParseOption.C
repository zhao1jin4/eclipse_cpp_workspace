...
namespace myoption
{
	...
	void parseOption2(int argc, char* argv[])
	{
		...
		struct option longopts[] = { { "oracle-username", 1, NULL, 'u' }, { "oracle-password", 1, NULL, 'p' }, { "oracle-sid", 1, NULL, 's' }, { "help", 0, NULL, 'h' }, { 0, 0, 0, 0 } };
		int option_index = 0;
		int opt;
